...
setInterval(function(){
    ...
    if (bbb=="true"){
        $('.nCRS0NbY').children().each(function(index,element){
            if(index==3){
                $(this).after('<div class="H-dq9euC DownloadURL" onclick="download3();download4()"><svg width="32" height="32" fill="#4F5168" xmlns="http://www.w3.org/2000/svg" class="tI80-Ts9 _3A6+KdLw" viewBox="0 0 36 36"><path d="M23 14l-8 8-8-8h5v-12h6v12zM15 22h-15v8h30v-8h-15zM28 26h-4v-2h4v2z"></path></svg><span class="iR6dOMAO">下载</span></div>');
                return false;
            };
        });
    };

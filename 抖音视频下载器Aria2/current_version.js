...
setInterval(function(){
    ...
    if (aaa=="true"){
        $('.swiper-slide-active .xgplayer-video-interaction-wrap').children().each(function(index,element){
            if(index==0){
                $(this).after('<div class="ypM1fp5X DownloadURL" onclick="download1()"><div class="NRiH5zYV"><div class="AtVWTnHH eXSpjSs0"><div class="y_R7XRDh"><svg width="42" height="36" xmlns="http://www.w3.org/2000/svg" class="" viewBox="0 0 36 36"><path d="M23 14l-8 8-8-8h5v-12h6v12zM15 22h-15v8h30v-8h-15zM28 26h-4v-2h4v2z"></path></svg></div><div class="CvfHMVww">下载</div></div></div></div>');
                return false;
            };
        });
    };
    ...
    if (bbb=="true"){
        $('.UwvcKsMK').children().each(function(index,element){
            if(index==3){
                $(this).after('<div class="kr4MM4DQ DownloadURL" onclick="download3();download4()"><svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" class="u1O5vnab eclJUOOC" viewBox="0 0 36 36"><path d="M23 14l-8 8-8-8h5v-12h6v12zM15 22h-15v8h30v-8h-15zM28 26h-4v-2h4v2z"></path></svg><span class="CE7XkkTw">下载</span></div>');
                return false;
            };
        });
    };

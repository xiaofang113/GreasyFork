...
$("head").prepend("<script>function download1(){$('.swiper-slide-active video').children().each(function(){var downloadURL= $(this).attr('src');console.log(downloadURL);if(downloadURL.length>10){window.location.href = downloadURL;};return false;});}</script>")
$("head").prepend("<script>function download2(){var downloadURL=$('.swiper-slide-active video').attr('src');if(downloadURL.length>10){window.location.href = downloadURL;};console.log(downloadURL);}</script>")
$("head").prepend("<script>function download3(){$('.xg-video-container video').children().each(function(){var downloadURL= $(this).attr('src');console.log(downloadURL);if(downloadURL.length>10){window.location.href = downloadURL;};return false;});}</script>")
$("head").prepend("<script>function download4(){var downloadURL=$('.xg-video-container video').attr('src');if(downloadURL.length>10){window.location.href = downloadURL;};console.log(downloadURL);}</script>")
